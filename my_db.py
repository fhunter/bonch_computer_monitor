...
class Uptime(Base):
    ...
    def __repr__(self):
        return f"<Uptime(last_report='{self.last_report}' computer='{self.computer}' uptime='{self.uptime}')>"
...
class ComputerSession(Base):
    ...
    def __repr__(self):
        return f"<ComputerSession(start='{self.session_start}', end='{self.session_end}', computer='{self.computer}')>"
...
class UserSession(Base):
    ...
    def __repr__(self):
        return f"<UserSession(start='{self.session_start}', end='{self.session_end}', computer='{self.computer}' username='{self.username}')>"
